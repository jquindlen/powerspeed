 ...
 ?><article <?php post_class(); ?>>
	<div class="card powerspeed-content-card powerspeed-main-content-container <?php echo esc_attr(get_theme_mod('powerspeed_border_main_content_type', '')); ?>">
	  ...
	  <div class="card-body">
	    ...
	    if(esc_attr(get_theme_mod('powerspeed_section_blog_show_metabox')) == false) {
				$powerspeed_section_blog_show_metabox = false;
			}
			if(esc_attr(get_theme_mod('powerspeed_section_blog_show_author')) == false) {
				$powerspeed_section_blog_show_author = false;
			}
			if(esc_attr(get_theme_mod('powerspeed_section_blog_show_categories')) == false) {
				$powerspeed_section_blog_show_categories = false;
			}
			if(esc_attr(get_theme_mod('powerspeed_section_blog_show_tags')) == false) {
