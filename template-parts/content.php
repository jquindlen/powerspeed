<?php
 ...
 ?><article <?php post_class(); ?>>
	<div class="card powerspeed-content-card powerspeed-main-content-container <?php if(is_sticky()) { echo ' bg-light';} ?> <?php echo esc_attr(get_theme_mod('powerspeed_border_main_content_type', '')); ?>">
