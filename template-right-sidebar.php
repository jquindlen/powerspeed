		...
		<main>
			...
			<section class="powerspeed-singles">
				<div class="container<?php if(esc_attr(get_theme_mod('powerspeed_section_main_content_fluid', false)) == true) { echo '-fluid'; }?>">
					<div class="row">
						<div id="powerspeed-main-content" class="powerspeed-single powerspeed-page powerspeed-main-content <?php if( is_active_sidebar('powerspeed_main_sidebar') ) { ?>col-md-9<?php } else {?>col-12<?php } ?>">
							<?php
                while(have_posts()) {
                  the_post();
